...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public long insertHike(String name, String location, String parking, String date, String length, String level, String description, String quantity, String type) {
        ...
        contentValues.put(Constants.H_QUANTITY, quantity);
        contentValues.put(Constants.H_TYPE, type);
    ...
    public long insertObser(String name, String time, String comment, String hikeID) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void updateHike(String id, String name, String location, String parking, String date, String length, String level, String description, String quantity, String type) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public ArrayList<ModelHike> getAllData() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ModelHike modelHike = new ModelHike("" + cursor.getInt(cursor.getColumnIndexOrThrow(Constants.H_ID)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.H_NAME)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.H_LOCATION)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.H_PARKING)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.H_DATE)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.H_LENGTH)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.H_LEVEL)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.H_DESCRIPTION)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.H_QUANTITY)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.H_TYPE)));
    ...
    public ArrayList<ModelObservation> getAllObserData(String id) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ModelObservation ModelObservation = new ModelObservation("" + cursor.getInt(cursor.getColumnIndexOrThrow(Constants.O_ID)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.O_NAME)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.O_TIME)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.O_COMMENT)), "" + cursor.getString(cursor.getColumnIndexOrThrow(Constants.O_HIKEID)));
