...
public class Constants {
    public static final String DATABASE_NAME = "HIKE_DATABASE";
    ...
    public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "( " + H_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + H_NAME + " TEXT, " + H_LOCATION + " TEXT, " + H_PARKING + " TEXT, " + H_DATE + " TEXT, " + H_LENGTH + " TEXT, " + H_LEVEL + " TEXT, " + H_DESCRIPTION + " TEXT, " + H_QUANTITY + " TEXT, " + H_TYPE + " TEXT " + " );";
    ...
    public static final String OBS_CREATE_TABLE = "CREATE TABLE " + OBS_TABLE_NAME + "( " + O_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + O_NAME + " TEXT, " + O_TIME + " TEXT, " + O_COMMENT + " TEXT, " + O_HIKEID + " TEXT" + " );";
}
